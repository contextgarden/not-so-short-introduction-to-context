...
pair a[];
aa=(0,0);
ab=(La,0);        ac=(La+Ra,-Ra);         ad=(La,-2Ra);
ae=(Lb,-2Ra);     af=(Lb-Rb,-2Ra+Rb);     ag=(Lb,-2Ra+2Rb);
ah=(Lc,-2Ra+2Rb); ai=(Lc+Rc,-2Ra+2Rb-Rc); aj=(Lc,-2Ra+2Rb-2Rc);
ak=(1u,-2Ra+2Rb-2Rc);

pa := (aa--ab..ac..ad--ae..af..ag--ah..ai..aj--ak) rotated 45;
...
\setupfootertexts[margin][{\color[darkred]{\pagenumber}}][]
\stopsetups
...
\startsection[title={En-tête et pied de page}]
\setup[hide]
...
\startpart [title={Composition spécifique}] 
