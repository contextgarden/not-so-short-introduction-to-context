...
\startitemize[packed]
  ...
  \item Les quatre macro-sections commencent une nouvelle page.
...
Il est également possible de créer de nouvelles macro-sections avec \PlaceMacro{definesectionblock} \tex{definesectionblock}.
