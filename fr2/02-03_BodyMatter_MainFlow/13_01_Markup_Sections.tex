...
Ce chapitre se concentre sur l'analyse du mécanisme que propose \ConTeXt\ pour mettre en œuvre ces divisions structurelles. Je les désignerai par le terme général de \quotation{sections}.
