...
\tex{fillinrules} a un rôle très proche de \tex{fillinline} mais plus général car elle permet d'insérer plus d'une ligne (option \MyKey{n}) et traite automatiquement le changement de ligne et de paragraphe.
