...
Et maintenant, à titre d'exemple, je vais transcrire le code avec lequel la \in{table}[tbl:tablecommands] suivante a été écrite. % Pourquoi la légende du tableau est-elle "Table" et pas "Tableau" comme d'habitude ??
...
Pour finir, l'environnement tabulate présente les commandes habituelles pour en définir des variantes, avec \tex{definetabulate}, et les configurer, avec \tex{setuptabulate}.
