...
où le premier {\em Name} est le nom sous lequel cette nouvelle construction sera connue, le second correspond à un environment de description déjà existant et dont le nouveau va hériter, et le dernier argument contrôle ce à quoi notre nouvel environment ressemblera. Après la déclaration précédente, nous aurons une nouvelle commande et un environnement portant le nom que nous avons choisi. Ainsi~:
