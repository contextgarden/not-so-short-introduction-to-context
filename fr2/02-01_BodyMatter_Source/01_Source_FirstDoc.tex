...
Ce chapitre est consacré à la mise en œuvre d'un premier exemple afin d'expliquer la structure de base d'un document \ConTeXt\ ainsi que les meilleures stratégies pour faire face aux éventuelles erreurs.
...
J'appelle ainsi les erreurs qui se produisent lorsque vous appelez une commande sans fournir certains arguments qui sont obligatoire, ou lorsque les règles de syntaxe de la commande ne sont pas respectées.
\stopdescription
