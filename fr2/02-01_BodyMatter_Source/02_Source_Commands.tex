...
Le contrôle de la distance de séparation entre les paragraphes, ne se fait donc pas en jouant sur le nombre de ligne vide dans le code source. 
...
\startSmallPrint
  ...
  En revanche, les commandes \PlaceMacro{begingroup}\tex{begingroup} et \PlaceMacro{endgroup}\tex{endgroup} ne sont pas interchangeables avec les accolades ou les commandes \tex{bgroup ... \egroup}, car un groupe commencé avec \tex{begingroup} doit être fermé avec \tex{endgroup}. Ces dernières commandes ont été conçues pour permettre une vérification beaucoup plus approfondie des erreurs. En général, les utilisateurs normaux n'ont pas à les utiliser.  % dans \tex{bgroup ... \egroup} faut-il le \ devant egroup ?
