...
\startsemitable{\&}
\TeX\ et \LaTeX\ réservent ce caractère pour aligner certains éléments verticalement dans les tableaux de base et, un contexte mathématique, dans les équations ou les écritures matricielles. \ConTeXt\ n'utilise plus vraiment \Doubt ce caractère mais il reste réservé. Pour aligner les éléments verticalement, sans doute dans un soucis de standardisation, \ConTeXt\ invite plutôt à utiliser la commande \tex{NC} (nouvelle colonne)  que l'on retrouve dans les textes tabulés et dans les tableaux.
\stopsemitable
...
le {\tt .} de la première ligne et le {\tt V} de la seconde. De même l'avant dernière ligne n'est considérée que comme une succession de caractères espaces absorbés le saut de ligne de la ligne précédente, considéré lui me comme un caractère espace car en fin d'une ligne non vide.
...
\item tiret moyen (--), ou tiret demi-cadratin, légèrement plus longs que le précédente. Il a plusieurs usages dont ceux, pour certaines langues européennes (moins en anglais), de lister les énumérations, ou de séparer les chiffres les moins élevés des chiffres les plus élevés dans une fourchette de dates ou de pages ; \quotation{pp. 12--33}.
...
\startsubsection
  [title=Définir des versions personnalisée de commande configurables ({\tt defineQuelqueChose})]
...
% ==============================================================================
% * 3.8 Liste officielle des commande ======================================
