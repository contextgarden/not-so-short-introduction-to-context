...
\stopsemitable % à la compilation apparaît ici une ligne vide !!! C'est peut-être l'effet de la formule mathématique, mais c'est gênant ! J'ai testé et cela n'apparaît pas. Est-ce un effet du semitable ?
...
Aussi \TeX\ interprète différemment une succession de tirets simples dans le fichier source (voir \in{table} [tbl:rules]) et \ConTeXt\ propose  des commandes spécifiques. % \in{tableau}[...] en accord avec le titre du tableau
...
\startitemize [packed]
  ...
  \item Avec l'ouverture de certains environnements (commande \tex{startSomething}).   %  startQuelqueChose ???
...
\startitemize [packed]
  ...
  \item Avec la fermeture de l'environnement (commande \tex{stopSomething}).   % stopQuelqueChose ??
