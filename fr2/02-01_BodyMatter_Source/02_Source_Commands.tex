...
Les commandes de \ConTeXt\ sont essentiellement de deux sortes : les caractères réservés qui permettent le balisage, et les commandes proprement dites.
...
Lorsque \ConTeXt\ parcourt le fichier source, composé uniquement de caractères de texte puisqu'il s'agit d'un fichier texte, il doit d'une manière ou d'une autre distinguer ce qui est le contenu textuel à composer et mettre en page des règles de compositions et de mise en page à proprement parler.

Ce sont les 11 caractères suivants, dits {\em caractères réservés}, qui permettent de faire cette distinction. Les cinq premiers sont vraiment essentiels au sens où il est très probable que vous les utilisiez régulièrement.
...
% * 3.2 Les groupes et le balisage =========================================
...
% * 3.3 commandes à proprement parler ==================================
...
% * 3.4 Le périmétre des commandes =========================================
...
% * 3.5 Les options de fonctionnement des commandes ========================
