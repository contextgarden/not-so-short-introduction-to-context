...
\item Utilisé avec deux arguments, le contenu du premier argument sera placé sur le côté gauche de l'en-tête ou du pied de page, et celui du second argument sur le côté droit. Par exemple, \tex{setupheadertexts[Préface][pagenumber]} composera un en-tête de page dans lequel le mot \quotation{Préface} sera écrit sur le côté gauche et le numéro de page sera imprimé sur le côté droit.
...
La première commande écrira \quotation{and} au centre de l'en-tête et la seconde écrira \quotation{Tweedledum} à gauche et \quotation{Tweedledee} à droite, laissant la zone centrale intacte, puisqu'il n'a pas été demandé de la réécrire. L'en-tête qui en résulte se présente alors comme suit~: 
...
\item Le lier à la section à laquelle il doit s'appliquer.
