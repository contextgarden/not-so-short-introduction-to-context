...
Et ils utilisent un codage particulier des caractères 
...
Pour le texte à proprement parler de votre document (les mots, les paragraphes), 
...
toutes ces informations (sémantique, couleurs, composition, mise en page...) 
...
l'utilisateur doit encore indiquer les règles de composition et de mise en page
à appliquer à chaque type,
c'est la {\em composition et mise en page}.
...
Ce qui est très appréciable et apprécié, c'est que la configuration par défaut donne d'excellents résultats et
il suffit ensuite de la personnaliser, la compléter, la détailler.

L'art de la composition étant particulièrement riche et vaste ( \quotation{tout est permis} et \quotation{l'imagination est la seule limite}),
le vocabulaire de \ConTeXt\ l'est également, même s'il bénéficie d'un effort continu de standardisation depuis 1990.
...
Pour s'y repérer, ce document procéde en 4 parties.
