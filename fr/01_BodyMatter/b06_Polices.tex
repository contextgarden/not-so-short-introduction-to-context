...
\startchapter
  [
    ...
    title=Polices d'écriture et couleurs dans \ConTeXt,
    bookmark=Polices d'écriture et couleurs dans \ConTeXt,
  ]
...
\startsection
  [title=Utilisation et configuration des couleurs]
...
nous définissons une commande spécifique avec \tex{definehighlight} auquel nous associons une couleur. Pour exemple~:
