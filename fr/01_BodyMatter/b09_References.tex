...
Pour finir avec les fonctionnalités d'interactivité de \ConTeXt, il permet d'introduire des pièces attachées dans vos documents avec la commande \tex{attachment}. 
