...
\startchapter
  [
    reference=cap:pages,
    title=Pages et pagination,
    bookmark=Pages et pagination,
  ]

\TocChap

\ConTeXt\ transforme le document source en {\em pages} correctement formatées. L'aspect de ces pages, la façon dont le texte et les espaces vides sont répartis et les éléments qu'elles comportent sont autant d'éléments fondamentaux pour une bonne composition. Ce chapitre est consacré à toutes ces questions, ainsi qu'à d'autres sujets relatifs à la pagination.
...
\subsubsubject{Syntaxe alternative de \tex{setuppapersize}}
...
\subsubsubject{Définition d'un format de page personnalisé}
...
% \placefigure [here,none] [] {}{\typesetbuffer[a7-bufA][frame=on,page=1]}
% \placefigure [here,none] [] {}{\typesetbuffer[a7-bufB][frame=on,page=1]}
...
\placefigure [here,none] [] {}{\typesetbuffer[a7-bufC][frame=on,page=1]
\attachment
...
\placefigure [here,none] [] {}{\typesetbuffer[a7-bufD][frame=on,page=1]
\attachment
...
\margintext[margin=normal]{\tfxx exemple de\\ \tex{margintext[margin=normal]}, où l'on constate que le texte est dans la marge de gauche mais collé au texte et justifié à droite}
